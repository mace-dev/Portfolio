...
// Function to toggle the visibility of the "About Me" details section
function toggleAboutMe() {
    var aboutMeDetails = document.getElementById("aboutMeDetails");
    aboutMeDetails.classList.toggle("show");
}

// Event listener for the "About Me" button
document.getElementById("explorePortfolioButton").addEventListener("click", function() {
    toggleAboutMe();
});
